    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <p><i class="fa fa-map-marker-alt me-3"></i>Lucknow</p>
                <p><i class="fa fa-phone-alt me-3"></i>+91 8840677854</p>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="d-flex">
                    <a class="btn btn-square rounded-circle me-1" href="https://x.com/ad545454nan?s=21"><i class="fab fa-twitter"></i></a>
                    <a class="btn btn-square rounded-circle me-1" href="https://www.facebook.com/profile.php?id=100014817736658&mibextid=ZbWKwL"><i class="fab fa-facebook-f"></i></a>
                    <a class="btn btn-square rounded-circle me-1" href="https://instagram.com/notesjila"><i class="fab fa-youtube"></i></a>
                    <a class="btn btn-square rounded-circle me-1" href="https://www.linkedin.com/in/ahmad-lasani-2868b8262/"><i class="fab fa-linkedin-in"></i></a>
                </div>
            </div>
        </div>
    </div>
